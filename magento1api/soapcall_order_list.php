...
$filter_status = array('status'=>'Pagamento Confirmado');
### END CONFIG ###
...
$result = $proxy->salesOrderList($sessionId, $filter_status);
echo sprintf("<p>Order List (%s): %s</p>", count($result), '<pre>'.var_export
($result,
    true). '</pre>');
